...
def define_model():
    ...
    return mechanistic_model, population_model, parameters
...
def generate_data(mechanistic_model, population_model, parameters, covariates):
...
if __name__ == '__main__':
    n = 100
    mm, pm, p = define_model()
    c = define_demographics(n)
    d = generate_data(mm, pm, p, c)
