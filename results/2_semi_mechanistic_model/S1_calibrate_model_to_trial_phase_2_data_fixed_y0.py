...
def define_log_posterior():
    ...
    mechanistic_model,_ = define_hamberg_model(baseline_inr=1)
    ...
    population_model = define_hamberg_population_model(
        centered=False, inr=True, conc=False, fixed_y0=True)
...
def run_inference(log_posterior):
    ...
    posterior_samples.sel(
        ...
        directory +
        '/posteriors/posterior_trial_phase_II_fixed_y0.nc'
    )
