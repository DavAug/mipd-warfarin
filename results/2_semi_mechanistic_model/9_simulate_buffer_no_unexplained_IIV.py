...
if __name__ == '__main__':
    ...
    pop_parameters = np.vstack([
        ...
        posterior2['Log std. global.baseline_inr'].values.flatten() * 1E-3,
        posterior2['Rel. baseline INR A'].values.flatten(),
        posterior3['Log mean global.elimination_rate'].values.flatten(),
        posterior2['Log std. global.elimination_rate'].values.flatten() * 1E-3,
        ...
        posterior2['Log std. global.volume'].values.flatten() * 1E-3,
