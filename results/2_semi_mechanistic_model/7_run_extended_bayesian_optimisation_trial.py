...
class SquaredINRDistance(pints.ErrorMeasure):
    ...
    def __init__(
        ...
        self._duration = 0.01
        self._n_doses = 14 - self._n_init_doses
    ...
    def _define_regimen(self, doses):
        ...
        self._doses[self._n_init_doses:13] = np.array(doses[:-1])
        self._doses[13:] = doses[-1]
