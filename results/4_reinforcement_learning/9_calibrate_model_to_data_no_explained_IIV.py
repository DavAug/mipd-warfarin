...
def load_data(target):
    ...
    data = pd.read_csv(
        directory + '/data/S10_maintenance_distribution_no_explained_IIV.csv')
...
def plot_progress(performance, best_epoch):
    ...
    plt.savefig(
        directory + '/4_dqn_training_no_explained_IIV.pdf',
        bbox_inches='tight')
    plt.savefig(
        directory + '/4_dqn_training_no_explained_IIV.tif',
        bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    filename = '/models/dqn_model_latest_no_explained_IIV.pickle'
